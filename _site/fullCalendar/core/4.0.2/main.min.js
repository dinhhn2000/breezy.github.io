...
!function (e, t) {
    ...
    function t(e, t, n) {
        ...
        if (t)
            for (var i in t)
                "style" === i ? g(r, t[i]) : mi[i] ? r[i] = t[i] : r.setAttribute(i, t[i]);
    ...
    function kt(e) {
        var t, n;
        return function () {
            return t && Mt(t, arguments) || (t = arguments,
    ...
    function xt(e, t, n, r, i) {
        return e = e.replace(Ni, ""),
            ...
            !1 === r.meridiem ? e = e.replace(Pi, "").trim() : "narrow" === r.meridiem ? e = e.replace(Pi, function (e, t) {
    ...
    function Vt(e, t) {
        return "object" == typeof e && e ? ("string" == typeof t && (e = ki({
            ...
            new Ui(e)) : "string" == typeof e ? new Li(e, t) : "function" == typeof e ? new Ai(e) : void 0
    }
    function Bt(e, t, n) {
        void 0 === n && (n = !1);
        var r = e.toISOString();
    ...
    function vn(e, t, n, r) {
        ...
        for (var p in s) {
            var h = s[p]
                ...
                , g = u[h.defId]
                , y = a[h.defId];
            if (!yn(g.constraints, v, l, e.businessHours, t))
                return !1;
            ...
            for (var E in d) {
                ...
                if (Tt(v, S.range)) {
                    ...
                    if (!1 === g.overlap)
                        return !1;
                    if (m && !m(new Bi(t, c[S.defId], S), new Bi(t, y, h)))
                        return !1
                }
            }
            for (var D = 0, b = g.allows; D < b.length; D++) {
                var T = b[D]
                    ...
                    , C = void 0;
                if (C = R ? new Bi(t, R, I) : new Bi(t, y),
    ...
    function gn(e, t, n, r) {
        var i = e.eventStore
            ...
            , l = t.selectionConfig;
        if (r && (l = r(l)),
            !yn(l.constraints, u, i, e.businessHours, t))
            return !1;
    ...
    function _n(e, t, n, r, i) {
        ...
        return a.extendedProps = ki(o, a.extendedProps || {}),
    ...
    function Vn(e, t, n) {
        return void 0 === n && (n = 1),
            e === t || (Array.isArray(e) && Array.isArray(t) ? Bn(e, t, n) : !("object" != typeof e || !e || "object" != typeof t || !t) && Fn(e, t, n))
    }
    function Bn(e, t, n) {
        if (void 0 === n && (n = 1),
            e === t)
    ...
    function Yn(e, t, n, r) {
        ...
        return t instanceof Date ? i = t : (i = t.date,
            ...
            n = n ? " " + wn(n) : "",
            r = r || "",
            !a && e.opt("navLinks") ? "<a" + n + ' data-goto="' + bn(JSON.stringify(s)) + '">' + r + "</a>" : "<span" + n + ">" + r + "</span>"
    }
    function qn(e) {
    ...
    function Gn(e, t, n, r) {
        ...
        return Rt(t.activeRange, e) ? (c.push("fc-" + Ri[e.getUTCDay()]),
    ...
    function gr(e) {
        var t = null
            ...
            , r = Mo.exec(e);
        r && (n = !r[1],
            n ? e += "T00:00:00Z" : e = e.replace(ko, function (e, n, r, i, o) {
    ...
    function Cr(e, t, n, r) {
        var i, o = e[t];
        return o && n === o.latestFetchId ? ki({}, e, (i = {},
            i[t] = ki({}, o, {
                isFetching: !1,
                fetchRange: r
            }),
    ...
    function ei(e, t) {
        ...
        return n = /^(year|month)$/.test(e.currentRangeUnit) ? e.currentRange : e.activeRange,
            this.dateEnv.formatRange(n.start, n.end, Vt(t.titleFormat || ti(e), t.titleRangeSeparator), {
    ...
    function gi(e, t, n, r, i, o, a, s) {
        var u, l = o.view, c = o.dateEnv, d = o.theme, f = o.options, p = Rt(t.activeRange, e), h = ["fc-day-header", d.getClass("widgetHeader")];
        return u = "function" == typeof f.columnHeaderHtml ? f.columnHeaderHtml(c.toDate(e)) : bn("function" == typeof f.columnHeaderText ? f.columnHeaderText(c.toDate(e)) : c.format(e, i)),
    ...
    var mi = {
        ...
        , Ui = function () {
            function e(e) {
                ...
                for (var i in e)
                    i in Oi ? (n[i] = e[i],
                        r = Math.max(Oi[i], r)) : (t[i] = e[i],
                            i in _i && (r = Math.max(_i[i], r)));
        ...
        , Ki = function (e) {
            ...
            return et(t, e),
                t.prototype.on = function (e, t) {
                    return Jn(this._handlers || (this._handlers = {}), e, t),
                        this
                }
                ,
                t.prototype.one = function (e, t) {
                    return Jn(this._oneHandlers || (this._oneHandlers = {}), e, t),
                        this
                }
                ,
                t.prototype.off = function (e, t) {
                    return this._handlers && Kn(this._handlers, e, t),
            ...
            return e.prototype.add = function (e) {
                ...
                e.prototype.compute = function () {
                    ...
                    this.dirDefaults = o,
                        ...
                        this.computed = ur([So, o, r, this.overrides, this.dynamicOverrides])
                }
                ,
                e
        }()
    ...
    var Mo = /^\s*\d{4}-\d\d-\d\d([T ]\d)?/
            ...
            return e.prototype.buildPrev = function (e, t) {
                ...
                e.prototype.build = function (e, t, n) {
                    ...
                    return r = this.buildValidRange(),
                        ...
                        s = a,
                        this.options.showNonCurrentDates || (s = Dt(s, i.range)),
                ...
                e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                    ...
                    return d || (o = this.options.dateIncrement,
                        o ? (a = ue(o),
                            d = be(a) < be(n) ? we(a, !de(o)).unit : r) : d = r),
        ...
        , Uo = function (e) {
            function r(n, r) {
                ...
                return i._renderLayout = An(i.renderLayout, i.unrenderLayout),
        ...
        , Lo = function (e) {
            ...
            return et(n, e),
                ...
                n.prototype.renderToolbars = function (e, t, n, r, i) {
                    ...
                    o ? (this.header || (this.header = new Uo(this.context, "fc-header-toolbar"),
                        s(this.el, this.header.el)),
                        this.header.receiveProps(ki({
                            layout: o
                        }, p))) : this.header && (this.header.destroy(),
                            this.header = null),
                        u ? (this.footer || (this.footer = new Uo(this.context, "fc-footer-toolbar"),
                            a(this.el, this.footer.el)),
                            this.footer.receiveProps(ki({
                                layout: u
            ...
            function t(t) {
                ...
                n.handleEventElRemove = function (e) {
                    ...
                    n.handleSegEnter = function (e, t) {
                        Jt(t) && (t.classList.add("fc-allow-mouse-resize"),
                            n.currentSegEl = t,
    ...
    var Zo = function () {
        ...
        return e.prototype.addPluginInputs = function (e) {
            ...
            e.prototype.render = function () {
                this.component ? this.requestRerender(!0) : (this.renderableEventStore = vt(),
                    this.bindHandlers(),
                    this.executeRender())
            }
            ,
            ...
            e.prototype.processOptions = function (e, t) {
                var n = this
                    ...
                    , a = !1;
                for (var s in e)
                    /^(height|contentHeight|aspectRatio)$/.test(s) ? o = !0 : /^(defaultDate|defaultView)$/.test(s) || (a = !0,
                        "timeZone" === s && (i = !0));
                "reset" === t ? (a = !0,
                    this.optionsManager.reset(e)) : "dynamic" === t ? this.optionsManager.addDynamic(e) : this.optionsManager.add(e),
                    a && (this.handleOptions(this.optionsManager.computed),
            ...
            e.prototype.getEventById = function (e) {
                ...
                for (var i in n) {
                    ...
                    if (o.publicId === e) {
                        if (o.recurringDef)
                            return new Bi(this, o, null);
                        for (var a in r) {
                            var s = r[a];
                            if (s.defId === o.defId)
                                return new Bi(this, o, s)
                        }
                    }
                }
                return null
        ...
        return et(n, e),
            ...
            n.prototype.updateNowIndicator = function () {
                this.props.dateProfile && this.initialNowDate && (this.unrenderNowIndicator(),
                    this.renderNowIndicator(V(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs)),
            ...
            n.prototype.queryScroll = function () {
                var e = {};
                return this.props.dateProfile && ki(e, this.queryDateScroll()),
                    e
            }
            ,
            n.prototype.applyScroll = function (e, t) {
                e.isDateInit && (delete e.isDateInit,
                    this.props.dateProfile && ki(e, this.computeInitialDateScroll())),
    ...
    Ki.mixInto(jo),
        jo.prototype.usesMinMaxTime = !1,
        jo.prototype.dateProfileGeneratorClass = xo;
    var Yo = function () {
        function e(e) {
            this.segs = [],
                this.isSizeDirty = !1,
    ...
    e.Calendar = Zo,
        ...
        e.DateComponent = ao,
        e.DateEnv = Oo,
        e.DateProfileGenerator = xo,
        e.DayHeader = Qo,
        e.DaySeries = $o,
        e.DayTable = ea,
        e.ElementDragging = Xo,
        e.ElementScrollController = eo,
        e.EmitterMixin = Ki,
        e.EventApi = Bi,
        e.FgEventRenderer = Yo,
        e.FillRenderer = qo,
        e.Interaction = Ao,
        e.Mixin = Ji,
        e.NamedTimeZoneImpl = Go,
        e.PositionCache = Qi,
        ...
        e.interactionSettingsStore = Vo,
        e.interactionSettingsToStore = ii,
        e.intersectRanges = Dt,
        e.intersectRects = E,
        e.isArraysEqual = Mt,
