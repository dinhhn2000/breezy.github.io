...
*/
!function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("@fullcalendar/core"), require("@fullcalendar/daygrid")) : "function" == typeof define && define.amd ? define(["exports", "@fullcalendar/core", "@fullcalendar/daygrid"], t) : (e = e || self,
    ...
    function n(e) {
        ...
        for (t = 0; t < e.length; t++) {
            for (r = e[t],
                i = 0; i < n.length && a(r, n[i]).length; i++)
                ;
            r.level = i,
                (n[i] || (n[i] = [])).push(r)
        }
    ...
    ***************************************************************************** */
    var u = function (e, t) {
            ...
            return i(r, e),
                ...
                r.prototype.computeSegSizes = function (e) {
                    var t = this
                        ...
                        , i = t.segsByCol
                        , n = r.colCnt;
                    if (r.computeSegVerticals(e),
                        i)
                        for (var o = 0; o < n; o++)
                            this.computeSegHorizontals(i[o])
                }
                ,
                r.prototype.assignSegSizes = function (e) {
                    var t = this
                        ...
                        , i = t.segsByCol
                        , n = r.colCnt;
                    if (r.assignSegVerticals(e),
                        i)
                        for (var o = 0; o < n; o++)
                            this.assignSegCss(i[o])
                }
                ,
                ...
                r.prototype.renderSegHtml = function (e, r) {
                    var i, n, o, s = e.eventRange, a = s.def, l = s.ui, d = a.allDay, c = l.startEditable, h = e.isStart && l.durationEditable && this.context.options.eventResizableFromStart, u = e.isEnd && l.durationEditable, p = this.getSegClasses(e, c, h || u, r), f = t.cssToStr(this.getSkinCss(l));
                    if (p.unshift("fc-time-grid-event"),
        ...
        , v = function (e) {
            function n(r, i, n) {
                ...
                return o.renderBusinessHours = t.memoizeRendering(a.renderSegs.bind(a, "businessHours"), a.unrender.bind(a, "businessHours"), [l]),
            ...
            return i(n, e),
                ...
                n.prototype.computeTimeTop = function (e) {
                    var r, i, n = this.slatEls.length, o = this.props.dateProfile, s = (e - t.asRoughMs(o.minTime)) / t.asRoughMs(this.slotDuration);
            ...
            function n(i, n, o, s) {
                ...
                a.splitter = new S,
                    a.renderHeadIntroHtml = function () {
                        ...
                        return a.opt("weekNumbers") ? (e = n.format(o.start, C),
            ...
            return i(n, e),
                ...
                n.prototype.updateBaseSize = function (e, r, i) {
                    ...
                    if (this.axisWidth = t.matchCellWidths(t.findElements(this.el, ".fc-axis")),
                        ...
                        return void (i || (o = this.computeScrollerHeight(r),
                    ...
                    this.timeGrid.bottomRuleEl.style.display = "none",
                        ...
                        i || (o = this.computeScrollerHeight(r),
                            ...
                            (s.left || s.right) && (l.forEach(function (e) {
    ...
    var b = function (e) {
        function r(r, i) {
            ...
            return n.buildDayRanges = t.memoize(c),
                n.slicer = new D,
                n.timeGrid = i,
        ...
        , w = function (e) {
            function n(i, n, o, s) {
                var a = e.call(this, i, n, o, s) || this;
                return a.buildDayTable = t.memoize(h),
